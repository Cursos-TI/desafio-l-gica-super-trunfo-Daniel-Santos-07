...
int main(){
     ...
     //Segunda carta a ser cadastrada
      ...
      printf("Carta %d - População: %lu \n", numero, populacao); // Exibe a população da primeira carta cadastrada para a melhor visualização da disputa.
       printf("Carta %d - População: %lu \n", numero2, populacao2);

       // Disputa entre as cartas com a mensagem dizendo qual carta é a vencedora, isso se repete com as demais informações.

      if(populacao > populacao2) {
          printf("A carta %d - População: %.2lu venceu! \n\n", numero, populacao);
      ...
      printf("Carta %d - Área: %.2f \n", numero, area); // Exibe a área da primeira carta cadastrada para a melhor visualização da disputa.
      printf("Carta %d - Área: %.2f \n", numero2, area2);

      if(area > area2) {
          printf("A carta %d - Área: %.2f venceu! \n\n", numero, area);
      } else if(area < area2) {
          printf("A carta %d - Área: %.2f venceu! \n\n", numero2, area2);
      } else {
      ...
      printf("Carta %d - PIB: %.2f  \n", numero, PIB); // Exibe o PIB da primeira carta cadastrada para a melhor visualização da disputa.
      printf("Carta %d - PIB: %.2f  \n", numero2, PIB2);

      if(PIB > PIB2) {
          printf("A carta %d - PIB: %.2f venceu! \n\n", numero, PIB);
      } else if(PIB < PIB2) {
          printf("A carta %d - PIB: %.2f venceu! \n\n", numero2, PIB2);
      } else {
      ...
      printf("Carta %d - Pontos Turísticos: %d \n", numero, numeropontosturisticos); // Exibe os pontos turísticos da primeira carta cadastrada para a melhor visualização da disputa.
      printf("Carta %d - Pontos Turísticos: %d \n", numero2, numeropontosturisticos2);

       if(numeropontosturisticos > numeropontosturisticos2) {
          printf("A carta %d - Pontos Turísticos: %.2d venceu! \n\n", numero, numeropontosturisticos);
      ...
      printf("Carta %d - Densidade Populacional: %.2f\n", numero, DensidadePopulacional); // Exibe a densidade populacional da primeira carta cadastrada para a melhor visualização da disputa.
      printf("Carta %d - Densidade Populacional: %.2f\n", numero2, DensidadePopulacional2);

      if(DensidadePopulacional < DensidadePopulacional2) {
          printf("A carta %d - Densidade Populacional: %.2f venceu! \n\n", numero, DensidadePopulacional);
      ...
      printf("Carta %d - PIB Per Capita: %.2f\n", numero, PIBPerCapita); // Exibe o PIB Per Capita da primeira carta cadastrada para a melhor visualização da disputa.
      printf("Carta %d - PIB Per Capita: %.2f\n", numero2, PIBPerCapita2);

       if(PIBPerCapita > PIBPerCapita2) {
          printf("A carta %d - PIB Per Capita: %.2f venceu! \n\n", numero, PIBPerCapita);
      ...
      printf("Carta %d - Super Poder: %.2f\n", numero, superPoder);  // Exibe o Super Poder da primeira carta cadastrada para a melhor visualização da disputa.
      printf("Carta %d - Super Poder: %.2f\n", numero2, superPoder2);

       if(superPoder > superPoder2) {
          printf("A carta %d - Super Poder: %.2f venceu! \n\n", numero, superPoder);
